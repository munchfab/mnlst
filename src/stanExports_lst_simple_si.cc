...
#include "stanExports_lst_simple_si.h"

RCPP_MODULE(stan_fit4lst_simple_si_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_lst_simple_si")
